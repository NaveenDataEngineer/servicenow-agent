...
2. Groq LLM evaluates the idea on feasibility, impact and cost
3. Each criteria is scored from 1 to 10
4. Overall score is calculated
5. Recommendation is generated - Approve or Reject
6. ServiceNow incident ticket is created automatically
